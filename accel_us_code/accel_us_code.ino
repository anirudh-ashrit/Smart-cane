...
// Header for Ultrasonic
#include "NewPing.h"

// Pins for I2C of Accelerometer
#define I2C_SDA 21
#define I2C_SCL 22
...
void setup(){
  ...
  // Setup operations of Ultrasonic Sensor
  ...
  // Setup operations of Accelerometer Sensor
...
void loop(){
  ...
  Serial.println(Amp);
  if (Amp <= 7 && trigger2 == false) { //if AM breaks lower threshold (0.4g)
    trigger1 = true;
