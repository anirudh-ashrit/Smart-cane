...
String mobile_number = "+14085901727";
...
const char auth[] = "cVBzqHYNbHDaXEwR8-rytOdLqxZiSS6u";
...
void checkGPS()                                    //Note: if didn't worked later, then add while befire if to check gps_serial.available
{
